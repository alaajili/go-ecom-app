...
func (s UserService) BecomeSeller(id uint, input dto.BecomeSellerDto) (string, error) {
	...
	bank_account := domain.BankAccount{
	...
	err = s.Repo.CreateBankAccount(bank_account)
	if err != nil {
